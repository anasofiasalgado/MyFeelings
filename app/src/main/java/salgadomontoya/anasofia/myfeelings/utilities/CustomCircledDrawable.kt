package salgadomontoya.anasofia.myfeelings.utilities

import android.content.Context
import android.graphics.*
import android.graphics.drawable.Drawable
import androidx.core.content.ContextCompat
import salgadomontoya.anasofia.myfeelings.R

class CustomCircledDrawable: Drawable {
    ...
    override fun draw(p0: Canvas) {
        ...
        val alto: Float= (p0.width - 25).toFloat()
